            ...
            <div class="dashboard-content">
                ...
                <form method="POST" enctype="multipart/form-data">
                    <?php foreach ($empDetails as $row) { ?>
                        ...
                        <div class="account-main">
                            <div class="employee-details">
                                <table>
                                    <tr>
                                        <td colspan="2"><h2>Update Employee Details</h2></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="fname" placeholder="Update first name" value="<?php echo $row['first_name']; ?>"></td>
                                    </tr>
                                    <tr>
                                        <td><span style="color: crimson">* </span><strong>Middle Name: </strong></td>
                                        <td><input type="text" name="mname" placeholder="Update middle name" value="<?php echo $row['middle_name']; ?>"></td>
                                    </tr>
                                    <tr>
                                        <td><span style="color: crimson">* </span><strong>Last Name: </strong></td>
                                        <td><input type="text" name="lname" placeholder="Update last name" value="<?php echo $row['last_name']; ?>"></td>
                                    </tr>
                                    <tr>
                                        <td><span style="color: crimson">* </span><strong>Date of Birth: </strong></td>
                                        <td><input type="date" name="dob" id="dobInput" value="<?php echo $row['date_of_birth']; ?>" onchange="updateAge()"></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <select name="sex">
                                                ...
                                                <option value="I" <?php echo ($row['sex'] === 'I') ? "selected" : ''; ?>>Intersex</option>
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="address" placeholder="Update address" value="<?php echo $row['address'] ?>"></td>
                                    </tr>
                                    <tr>
                                        <td><span style="color: crimson">* </span><strong>Religion: </strong></td>
                                        <td><input type="text" name="religion" placeholder="Update religion" value="<?php echo $row['religion'] ?>"></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="phonenum" placeholder="Update phone number" value="<?php echo $row['phone_no'] ?>"></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <select name="legislature">
                                                ...
                                                <option value="Barangay Secretary" <?php echo ($row['legislature'] === "Barangay Secretary") ? "selected" : ''; ?>>Barangay Secretary</option>
                                                <option value="Barangay Treasurer" <?php echo ($row['legislature'] === "Barangay Treasurer") ? "selected" : ''; ?>>Barangay Treasurer</option>
                            ...
                            <div class="account-details">
                                <table>
                                    <tr>
                                        <td colspan="2"><h2>Update Account Details</h2></td>
                                    </tr>
                                    <tr>
                                        <td><strong>Username: </strong></td>
                                        <td><input type="text" name="username" placeholder="Update username" value="<?php echo $row['username'] ?>"></td>
                                    </tr>
                                    <tr>
                        ...
                        <p id="warning"><span style="color: crimson;">* </span>Note: Some personal information will be under review before it will be updated.</p>
                    <?php } ?>
                    ...
                    <div class="account-actions">
                        ...
                        <button type="submit" name="cancel" class="change-password" id="changePwdBtn">Cancel Update</button>
                    </div>
                </form>
            </div>
        </div>
